...
// sessionHandle is an interface for transactions to access sessions safely. It is generated by Pool.take().
...
// getClient gets the resource associated with the session ID in sessionHandle.
